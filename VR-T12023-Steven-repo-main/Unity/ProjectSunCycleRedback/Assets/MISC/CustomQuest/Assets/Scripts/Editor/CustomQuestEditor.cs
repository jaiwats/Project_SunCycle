...
public class CustomQuestEditor : EditorWindow
{
        ...
        switch (prefabToolBarInt)
        {
            case 0:
                ...
                if (selectedQuest)
                {
                    ...
                    {
                        AssetDatabase.OpenAsset(AssetDatabase.LoadAssetAtPath("Assets/CustomQuest/Assets/Prefabs/Quests/" + selectedQuest.name + "/" + selectedQuest.name + ".cs", typeof(UnityEngine.Object)));
                    }
                    ...
                    EditorGUILayout.EndHorizontal();
                    GUI.backgroundColor = Color.white;
                    if (R_RewardList == null) { SelectQuest(selectedQuest); }
                    ...
                    if (!CustomQuestSettings.HideOptional)
                    {
                        ...
                        EditorGUILayout.EndHorizontal();
                        GUI.backgroundColor = Color.white;
                        if (R_OptionalRewardsList == null) { SelectQuest(selectedQuest); }
    ...
    private void DeleteCriteria(Criteria c)
    {
        ...
        if (AssetDatabase.LoadAssetAtPath("Assets/CustomQuest/Assets/Prefabs/Quests/" + selectedQuest.name + "/" + c.criteriaName + ".cs", typeof(MonoScript)))
        {
            AssetDatabase.DeleteAsset("Assets/CustomQuest/Assets/Prefabs/Quests/" + selectedQuest.name + "/" + c.criteriaName + ".cs");
        }
        DestroyImmediate(c, true);
        ClearFocus();
    }
    ...
    private void DeleteReward(Reward r)
    {
        ...
        if (AssetDatabase.LoadAssetAtPath("Assets/CustomQuest/Assets/Prefabs/Quests/" + selectedQuest.name + "/" + r.rewardName + ".cs", typeof(MonoScript)))
        {
            AssetDatabase.DeleteAsset("Assets/CustomQuest/Assets/Prefabs/Quests/" + selectedQuest.name + "/" + r.rewardName + ".cs");
        }
        DestroyImmediate(r, true);
        ClearFocus();
    }
